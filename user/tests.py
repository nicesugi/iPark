...
class UserRegistrationTest(APITestCase):
    ...
    def test_registration_wrong_password(self):
        ...
        self.assertEqual(
            ...
            "비밀번호는 8 자리 이상이며 최소 하나 이상의 영문자, 숫자, 특수문자가 필요합니다.",
        )
...
class UserLoginTest(APITestCase):
    ...
    def test_login_all_data(self):
        ...
        user_data = {"username": "user10", "password": "1010abc!"}
    ...
    def test_login_no_username(self):
        url = reverse("ipark_token")
        user_data = {"username": "", "password": "1010abc!"}
    ...
    def test_login_no_password(self):
        url = reverse("ipark_token")
        user_data = {"username": "user1010", "password": ""}
...
class UserInfoModifyDeleteTest(APITestCase):
    ...
    def setUpTestData(cls):
        ...
        cls.access_token = cls.client.post(reverse("ipark_token"), cls.login_data).data[
            "access"
        ]
    ...
    def test_modify_same_password(self):
        ...
        self.assertEqual(response.status_code, 400)
        self.assertEqual(
            response.data["password"], "현재 사용중인 비밀번호와 동일한 비밀번호는 입력할 수 없습니다."
        )
...
class SearchUsernameTest(APITestCase):
    ...
    def test_search_username(self):
        ...
        data = {"email": "user10@gmail.com", "phone": "010-1010-1010"}
    ...
    def test_search_username_no_email(self):
        url = reverse("myid_view")
        data = {"email": "", "phone": "010-1010-1010"}
    ...
    def test_search_username_no_email(self):
        url = reverse("myid_view")
        data = {"email": "user10@gmail.", "phone": "010-1010-1010"}

        data_2 = {"email": "user10", "phone": "010-1010-1010"}
    ...
    def test_search_username_no_phone(self):
        url = reverse("myid_view")
        data = {"email": "user10@gmail.com", "phone": ""}
...
class AlterPasswordTest(APITestCase):
    ...
    def test_post_user_info(self):
        ...
        user_data = {"username": "user10", "email": "user10@gmail.com"}
    ...
    def test_post_wrong_user_info(self):
        url = reverse("alter_password_view")
        user_data = {"username": "user30", "email": "user30@gmail.com"}
    ...
    def test_post_wrong_username_or_email(self):
        url = reverse("alter_password_view")
        user_data = {"username": "user30", "email": "user10@gmail.com"}
        user_data_2 = {"username": "user10", "email": "user30@gmail.com"}
        user_data_3 = {"username": "user10", "email": "user10@gmail"}
    ...
    def test_post_no_username_or_email(self):
        url = reverse("alter_password_view")
        user_data = {"username": "", "email": "user10@gmail.com"}
        user_data_2 = {"username": "user10", "email": ""}
    ...
    def test_alter_same_password(self):
        ...
        self.assertEqual(
            response.data["message"], "현재 사용중인 비밀번호와 동일한 비밀번호는 입력할 수 없습니다."
        )
...
class UserVerifyTest(APITestCase):
    ...
    def test_user_verify(self):
        ...
        data = {"username": "user10", "password": "1010abc!"}

        response = self.client.post(
            path=url, data=data, HTTP_AUTHORIZATION=f"Bearer {self.access_token}"
        )
    ...
    def test_user_verify_with_wrong_info(self):
        url = reverse("user_verification_view")
        data = {"username": "user20", "password": "1010abc!"}
        data_2 = {"username": "user10", "password": "1011abc!"}

        response = self.client.post(
            path=url, data=data, HTTP_AUTHORIZATION=f"Bearer {self.access_token}"
        )
        response_2 = self.client.post(
            path=url, data=data_2, HTTP_AUTHORIZATION=f"Bearer {self.access_token}"
        )
    ...
    def test_user_verify_with_wrong_info(self):
        url = reverse("user_verification_view")
        data = {"username": "", "password": "1010abc!"}
        data_2 = {"username": "user10", "password": ""}
